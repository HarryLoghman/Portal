        ...
        private void SendRenewalWarningToSinglechargeUsersInQueue()
        {
            try
            {
                ...
                using (var entity = new PhantomEntities())
                {
                    ...
                    var serviceId = SharedLibrary.ServiceHandler.GetServiceId("Phantom");
                    ...
                    foreach (var item in QueueList)
                    {
                        ...
                        var imiChargeObject = PhantomLibrary.MessageHandler.GetImiChargeObjectFromPrice(0, SharedLibrary.HandleSubscription.ServiceStatusForSubscriberState.Unspecified);
            ...
            try
            {
                ...
                using (var entity = new PhantomEntities())
                {
                    ...
                    foreach (var item in QueueList)
                    {
                        ...
                        //var singlecharge = PhantomLibrary.MessageHandler.SendSinglechargeMesssageToPardisImi(message);
