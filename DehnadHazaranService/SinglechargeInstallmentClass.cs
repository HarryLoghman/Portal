                                ...
                                if (isInBlackList != true)
                                {
                                    ...
                                    if (sub != null)
                                    {
                                        if (sub.SpecialUniqueId != null)
                                        {
                                            ...
                                            if (serviceAdditionalInfo["serviceCode"] == "Hazaran")
                                                await SharedLibrary.UsefulWebApis.DanoopReferral("http://79.175.164.52/Hazaran/platformCharge.php", string.Format("code={0}&number={1}&amount={2}&kc={3}", sub.SpecialUniqueId, message.MobileNumber, price, sha));
