...
namespace DehnadHazaranService
{
    class Sender : SharedShortCodeServiceLibrary.Sender
    {
        ...
        //        onDemandMessages = ((IEnumerable)HazaranLibrary.MessageHandler.GetUnprocessedMessages(SharedLibrary.MessageHandler.MessageType.OnDemand, readSize)).OfType<OnDemandMessagesBuffer>().ToList();
        ...
        //        {
        //            autochargeMessages = ((IEnumerable)HazaranLibrary.MessageHandler.GetUnprocessedMessages(SharedLibrary.MessageHandler.MessageType.AutoCharge, readSize)).OfType<AutochargeMessagesBuffer>().ToList();
        //            eventbaseMessages = ((IEnumerable)HazaranLibrary.MessageHandler.GetUnprocessedMessages(SharedLibrary.MessageHandler.MessageType.EventBase, readSize)).OfType<EventbaseMessagesBuffer>().ToList();
        ...
        //{
        //    await Task.Delay(10);
        //    using (var entity = new SharedServiceEntities(HazaranLibrary.SharedVariables.connectionStringInAppConfig))
        //    {
