        ...
        private void SendRenewalWarningToSinglechargeUsersInQueue()
        {
            try
            {
                ...
                using (var entity = new HazaranEntities())
                {
                    ...
                    var serviceId = SharedLibrary.ServiceHandler.GetServiceId("Hazaran");
                    ...
                    foreach (var item in QueueList)
                    {
                        ...
                        var imiChargeObject = HazaranLibrary.MessageHandler.GetImiChargeObjectFromPrice(0, SharedLibrary.HandleSubscription.ServiceStatusForSubscriberState.Unspecified);
            ...
            try
            {
                ...
                using (var entity = new HazaranEntities())
                {
                    ...
                    foreach (var item in QueueList)
                    {
                        ...
                        //var singlecharge = HazaranLibrary.MessageHandler.SendSinglechargeMesssageToPardisImi(message);
