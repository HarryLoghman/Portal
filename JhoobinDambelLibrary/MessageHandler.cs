...
using JhoobinDambelLibrary.Models;
using System.Net.Http;
using System.Xml;
using System.Xml.Linq;

namespace JhoobinDambelLibrary
{
    public class MessageHandler
    {
        ...
        public static long OtpLog(string mobileNumber, string otpType, string userMessage)
        {
            try
            {
                using (var entity = new JhoobinDambelEntities())
                {
                    var otpLog = new Otp()
                    {
        ...
        public static MessageObject SetImiChargeInfo(JhoobinDambelEntities entity, ImiChargeCode imiChargeCode, MessageObject message, int price, int messageType, SharedLibrary.HandleSubscription.ServiceStatusForSubscriberState? subscriberState)
        {
        ...
        public static List<OnDemandMessagesBuffer> GetUnprocessedOnDemandMessages(JhoobinDambelEntities entity, int readSize)
        {
        ...
        public static List<EventbaseMessagesBuffer> GetUnprocessedEventbaseMessages(JhoobinDambelEntities entity, int readSize)
        {
            var today = DateTime.Now.Date;
        ...
        public static List<AutochargeMessagesBuffer> GetUnprocessedAutochargeMessages(JhoobinDambelEntities entity, int readSize)
        {
            var today = DateTime.Now.Date;
        ...
        public static async Task SendMesssagesToPardisImi(JhoobinDambelEntities entity, dynamic messages, Dictionary<string, string> serviceAdditionalInfo)
        {
            try
            {
        ...
        public static async Task SendMesssagesToHub(JhoobinDambelEntities entityDisposeIt, dynamic messages, Dictionary<string, string> serviceAdditionalInfo)
        {
            try
            {
        ...
        public static async Task SendMesssagesToTelepromo(JhoobinDambelEntities entity, dynamic messages, Dictionary<string, string> serviceAdditionalInfo)
        {
            try
            {
                var messagesCount = messages.Count;
        ...
        public static async Task SendMesssagesToHamrahvas(JhoobinDambelEntities entity, dynamic messages, Dictionary<string, string> serviceAdditionalInfo)
        {
