            ...
            try
            {
                ...
                using (var entity = new SepidRoodEntities())
                {
                    ...
                    foreach (var item in autochargeTimeTable)
                    {
                        ...
                        {
                            var autochargeContent = SepidRoodLibrary.ServiceHandler.SelectAutochargeContentByDate(entity, subscriber.Id);
                        ...
                        SepidRoodLibrary.MessageHandler.CreateMonitoringItem(null, SharedLibrary.MessageHandler.MessageType.AutoCharge, messages.Count, tag);
                    }
                }
            }
            catch (Exception e)
