...
namespace MenchBazLibrary
{
    public class ServiceHandler
    {
        ...
        public static AutochargeContent SelectAutochargeContentByOrder(MenchBazEntities entity, long subscriberId)
        {
        ...
        public static AutochargeContent SelectAutochargeContentByDate(MenchBazEntities entity, long subscriberId)
        {
        ...
        public static AutochargeContent SelectAutochargeContent(MenchBazEntities entity, long subscriberId)
        {
            var today = DateTime.Now.Date;
            var autochargesAlreadyInQueue = entity.AutochargeMessagesBuffers.Where(o => DbFunctions.TruncateTime(o.DateAddedToQueue) == today).Select(o => o.Id).ToList();
