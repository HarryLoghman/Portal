        ...
        private void SendRenewalWarningToSinglechargeUsersInQueue()
        {
            try
            {
                ...
                using (var entity = new NebulaEntities())
                {
                    ...
                    var serviceId = SharedLibrary.ServiceHandler.GetServiceId("Nebula");
                    ...
                    foreach (var item in QueueList)
                    {
                        ...
                        var imiChargeObject = NebulaLibrary.MessageHandler.GetImiChargeObjectFromPrice(0, SharedLibrary.HandleSubscription.ServiceStatusForSubscriberState.Unspecified);
            ...
            try
            {
                ...
                using (var entity = new NebulaEntities())
                {
                    ...
                    foreach (var item in QueueList)
                    {
                        ...
                        //var singlecharge = NebulaLibrary.MessageHandler.SendSinglechargeMesssageToPardisImi(message);
