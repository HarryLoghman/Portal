...
namespace JhoobinPinLibrary
{
    public class MessageHandler
    {
        ...
        public static long OtpLog(string mobileNumber, string otpType, string userMessage)
        {
            try
            {
                using (var entity = new JhoobinPinEntities())
                {
                    var otpLog = new Otp()
                    {
        ...
        public static MessageObject SetImiChargeInfo(JhoobinPinEntities entity, ImiChargeCode imiChargeCode, MessageObject message, int price, int messageType, SharedLibrary.HandleSubscription.ServiceStatusForSubscriberState? subscriberState)
        {
        ...
        public static List<OnDemandMessagesBuffer> GetUnprocessedOnDemandMessages(JhoobinPinEntities entity, int readSize)
        {
        ...
        public static List<EventbaseMessagesBuffer> GetUnprocessedEventbaseMessages(JhoobinPinEntities entity, int readSize)
        {
            var today = DateTime.Now.Date;
        ...
        public static List<AutochargeMessagesBuffer> GetUnprocessedAutochargeMessages(JhoobinPinEntities entity, int readSize)
        {
            var today = DateTime.Now.Date;
        ...
        public static async Task SendMesssagesToPardisImi(JhoobinPinEntities entity, dynamic messages, Dictionary<string, string> serviceAdditionalInfo)
        {
            try
            {
        ...
        public static async Task SendMesssagesToHub(JhoobinPinEntities entityDisposeIt, dynamic messages, Dictionary<string, string> serviceAdditionalInfo)
        {
            try
            {
        ...
        public static async Task SendMesssagesToTelepromo(JhoobinPinEntities entity, dynamic messages, Dictionary<string, string> serviceAdditionalInfo)
        {
            try
            {
                var messagesCount = messages.Count;
        ...
        public static async Task SendMesssagesToHamrahvas(JhoobinPinEntities entity, dynamic messages, Dictionary<string, string> serviceAdditionalInfo)
        {
