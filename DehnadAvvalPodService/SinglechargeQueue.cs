        ...
        private void SendRenewalWarningToSinglechargeUsersInQueue()
        {
            try
            {
                ...
                using (var entity = new AvvalPodEntities())
                {
                    ...
                    var serviceId = SharedLibrary.ServiceHandler.GetServiceId("AvvalPod");
                    ...
                    foreach (var item in QueueList)
                    {
                        ...
                        var imiChargeObject = AvvalPodLibrary.MessageHandler.GetImiChargeObjectFromPrice(0, SharedLibrary.HandleSubscription.ServiceStatusForSubscriberState.Unspecified);
            ...
            try
            {
                ...
                using (var entity = new AvvalPodEntities())
                {
                    ...
                    foreach (var item in QueueList)
                    {
                        ...
                        //var singlecharge = AvvalPodLibrary.MessageHandler.SendSinglechargeMesssageToPardisImi(message);
