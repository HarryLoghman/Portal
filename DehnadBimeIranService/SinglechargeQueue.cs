            ...
            try
            {
                ...
                using (var entity = new BimeIranEntities())
                {
                    ...
                    foreach (var item in QueueList)
                    {
                        ...
                        var imiChargeObject = BimeIranLibrary.MessageHandler.GetImiChargeObjectFromPrice(0, SharedLibrary.HandleSubscription.ServiceStatusForSubscriberState.Unspecified);
            ...
            try
            {
                ...
                using (var entity = new BimeIranEntities())
                {
                    ...
                    foreach (var item in QueueList)
                    {
                        ...
                        //var singlecharge = BimeIranLibrary.MessageHandler.SendSinglechargeMesssageToPardisImi(message);
