...
namespace TahChinLibrary
{
    public class ServiceHandler
    {
        ...
        public static AutochargeContent SelectAutochargeContentByOrder(TahChinEntities entity, long subscriberId)
        {
        ...
        public static Singlecharge GetOTPRequestId(TahChinEntities entity, MessageObject message)
        {
            try
            {
        ...
        public static AutochargeContent SelectAutochargeContentByDate(TahChinEntities entity, long subscriberId)
        {
        ...
        public static AutochargeContent SelectAutochargeContent(TahChinEntities entity, long subscriberId)
        {
            var today = DateTime.Now.Date;
            var autochargesAlreadyInQueue = entity.AutochargeMessagesBuffers.Where(o => DbFunctions.TruncateTime(o.DateAddedToQueue) == today).Select(o => o.Id).ToList();
