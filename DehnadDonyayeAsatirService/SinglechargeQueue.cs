            ...
            try
            {
                ...
                using (var entity = new DonyayeAsatirEntities())
                {
                    ...
                    foreach (var item in QueueList)
                    {
                        ...
                        var imiChargeObject = DonyayeAsatirLibrary.MessageHandler.GetImiChargeObjectFromPrice(0, SharedLibrary.HandleSubscription.ServiceStatusForSubscriberState.Unspecified);
