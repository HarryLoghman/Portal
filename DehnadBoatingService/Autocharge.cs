            ...
            try
            {
                ...
                using (var entity = new BoatingEntities())
                {
                    ...
                    foreach (var item in autochargeTimeTable)
                    {
                        ...
                        {
                            var autochargeContent = BoatingLibrary.ServiceHandler.SelectAutochargeContentByDate(entity, subscriber.Id);
                        ...
                        BoatingLibrary.MessageHandler.CreateMonitoringItem(null, SharedLibrary.MessageHandler.MessageType.AutoCharge, messages.Count, tag);
                    }
                }
            }
            catch (Exception e)
