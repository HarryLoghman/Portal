...
namespace BimeKarbalaLibrary
{
    public class MessageHandler
    {
        ...
        public static List<OnDemandMessagesBuffer> GetUnprocessedOnDemandMessages(BimeKarbalaEntities entity, int readSize)
        {
        ...
        public static List<EventbaseMessagesBuffer> GetUnprocessedEventbaseMessages(BimeKarbalaEntities entity, int readSize)
        {
            var today = DateTime.Now.Date;
        ...
        public static List<AutochargeMessagesBuffer> GetUnprocessedAutochargeMessages(BimeKarbalaEntities entity, int readSize)
        {
            var today = DateTime.Now.Date;
        ...
        public static async Task SendMesssagesToPardisImi(BimeKarbalaEntities entity, dynamic messages, Dictionary<string, string> serviceAdditionalInfo)
        {
            try
            {
        ...
        public static async Task SendMesssagesToTelepromo(BimeKarbalaEntities entity, dynamic messages, Dictionary<string, string> serviceAdditionalInfo)
        {
            try
            {
                //var messagesCount = messages.Count;
                ...
                //if (pardisResponse.Rows.Count == 0)
                //{
                //    logs.Info("SendMessagesToTelepromo does not return response there must be somthing wrong with the parameters");
                //    foreach (var sms in smsList)
                //    {
                //        logs.Info("Index: " + sms.Index);
                //        logs.Info("Addresses: " + sms.Addresses);
        ...
        public static async Task SendMesssagesToHamrahvas(BimeKarbalaEntities entity, dynamic messages, Dictionary<string, string> serviceAdditionalInfo)
        {
