...
, chargeCodes, k, installmentCycleNumber, installmentInnerCycleNumber, isCampaignActive);
        ...
        public static async Task<Singlecharge> ChargeMtnSubscriber(
            ...
            TahChinEntities entity, MessageObject message, bool isRefund, bool isInAppPurchase, Dictionary<string, string> serviceAdditionalInfo, int installmentCycleNumber, int threadNumber, long installmentId = 0)
        {
