            ...
            try
            {
                ...
                using (var entity = new TahChinEntities())
                {
                    ...
                    foreach (var item in QueueList)
                    {
                        ...
                        var imiChargeObject = TahChinLibrary.MessageHandler.GetImiChargeObjectFromPrice(0, SharedLibrary.HandleSubscription.ServiceStatusForSubscriberState.Unspecified);
