...
namespace HazaranLibrary
{
    public class ServiceHandler
    {
        ...
        public static AutochargeContent SelectAutochargeContentByOrder(HazaranEntities entity, long subscriberId)
        {
        ...
        public static Singlecharge GetOTPRequestId(HazaranEntities entity, MessageObject message)
        {
            try
            {
        ...
        public static AutochargeContent SelectAutochargeContentByDate(HazaranEntities entity, long subscriberId)
        {
        ...
        public static AutochargeContent SelectAutochargeContent(HazaranEntities entity, long subscriberId)
        {
            var today = DateTime.Now.Date;
            var autochargesAlreadyInQueue = entity.AutochargeMessagesBuffers.Where(o => DbFunctions.TruncateTime(o.DateAddedToQueue) == today).Select(o => o.Id).ToList();
