...
namespace IrancellTestLibrary
{
    public class ServiceHandler
    {
        ...
        public static AutochargeContent SelectAutochargeContentByOrder(IrancellTestEntities entity, long subscriberId)
        {
        ...
        public static AutochargeContent SelectAutochargeContentByDate(IrancellTestEntities entity, long subscriberId)
        {
        ...
        public static AutochargeContent SelectAutochargeContent(IrancellTestEntities entity, long subscriberId)
        {
            var today = DateTime.Now.Date;
            var autochargesAlreadyInQueue = entity.AutochargeMessagesBuffers.Where(o => DbFunctions.TruncateTime(o.DateAddedToQueue) == today).Select(o => o.Id).ToList();
