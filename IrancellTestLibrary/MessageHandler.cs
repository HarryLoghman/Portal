...
namespace IrancellTestLibrary
{
    public class MessageHandler
    {
        ...
        {
            using (var entity = new IrancellTestEntities())
            {
        ...
        public static List<OnDemandMessagesBuffer> GetUnprocessedOnDemandMessages(IrancellTestEntities entity, int readSize)
        {
        ...
        public static List<EventbaseMessagesBuffer> GetUnprocessedEventbaseMessages(IrancellTestEntities entity, int readSize)
        {
            var today = DateTime.Now.Date;
        ...
        public static List<AutochargeMessagesBuffer> GetUnprocessedAutochargeMessages(IrancellTestEntities entity, int readSize)
        {
            var today = DateTime.Now.Date;
        ...
        public static async Task SendMesssagesToPardisImi(IrancellTestEntities entity, dynamic messages, Dictionary<string, string> serviceAdditionalInfo)
        {
            try
            {
        ...
        public static async Task SendMesssagesToHub(IrancellTestEntities entityDisposeIt, dynamic messages, Dictionary<string, string> serviceAdditionalInfo)
        {
            try
            {
        ...
        public static async Task SendMesssagesToTelepromo(IrancellTestEntities entity, dynamic messages, Dictionary<string, string> serviceAdditionalInfo)
        {
            try
            {
                var messagesCount = messages.Count;
        ...
        public static async Task SendMesssagesToHamrahvas(IrancellTestEntities entity, dynamic messages, Dictionary<string, string> serviceAdditionalInfo)
        {
