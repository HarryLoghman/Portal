        ...
        private void SendRenewalWarningToSinglechargeUsersInQueue()
        {
            try
            {
                ...
                using (var entity = new TakavarEntities())
                {
                    ...
                    var serviceId = SharedLibrary.ServiceHandler.GetServiceId("Takavar");
                    ...
                    foreach (var item in QueueList)
                    {
                        ...
                        var imiChargeObject = TakavarLibrary.MessageHandler.GetImiChargeObjectFromPrice(0, SharedLibrary.HandleSubscription.ServiceStatusForSubscriberState.Unspecified);
            ...
            try
            {
                ...
                using (var entity = new TakavarEntities())
                {
                    ...
                    foreach (var item in QueueList)
                    {
                        ...
                        //var singlecharge = TakavarLibrary.MessageHandler.SendSinglechargeMesssageToPardisImi(message);
