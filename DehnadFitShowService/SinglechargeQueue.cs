            ...
            try
            {
                ...
                using (var entity = new FitShowEntities())
                {
                    ...
                    foreach (var item in QueueList)
                    {
                        ...
                        var imiChargeObject = FitShowLibrary.MessageHandler.GetImiChargeObjectFromPrice(0, SharedLibrary.HandleSubscription.ServiceStatusForSubscriberState.Unspecified);
            ...
            try
            {
                ...
                using (var entity = new FitShowEntities())
                {
                    ...
                    foreach (var item in QueueList)
                    {
                        ...
                        //var singlecharge = FitShowLibrary.MessageHandler.SendSinglechargeMesssageToPardisImi(message);
