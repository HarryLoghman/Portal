        ...
        private void SendRenewalWarningToSinglechargeUsersInQueue()
        {
            try
            {
                ...
                using (var entity = new ShenoYad500Entities())
                {
                    ...
                    var serviceId = SharedLibrary.ServiceHandler.GetServiceId("ShenoYad500");
                    ...
                    foreach (var item in QueueList)
                    {
                        ...
                        var imiChargeObject = ShenoYad500Library.MessageHandler.GetImiChargeObjectFromPrice(0, SharedLibrary.HandleSubscription.ServiceStatusForSubscriberState.Unspecified);
                        ...
                        ShenoYad500Library.MessageHandler.InsertMessageToQueue(message);
            ...
            try
            {
                ...
                using (var entity = new ShenoYad500Entities())
                {
                    ...
                    foreach (var item in QueueList)
                    {
                        ...
                        //var singlecharge = ShenoYad500Library.MessageHandler.SendSinglechargeMesssageToPardisImi(message);
