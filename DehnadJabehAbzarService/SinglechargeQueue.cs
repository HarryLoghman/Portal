        ...
        private void SendRenewalWarningToSinglechargeUsersInQueue()
        {
            try
            {
                ...
                using (var entity = new JabehAbzarEntities())
                {
                    ...
                    var serviceId = SharedLibrary.ServiceHandler.GetServiceId("JabehAbzar");
                    ...
                    foreach (var item in QueueList)
                    {
                        ...
                        var imiChargeObject = JabehAbzarLibrary.MessageHandler.GetImiChargeObjectFromPrice(0, SharedLibrary.HandleSubscription.ServiceStatusForSubscriberState.Unspecified);
            ...
            try
            {
                ...
                using (var entity = new JabehAbzarEntities())
                {
                    ...
                    foreach (var item in QueueList)
                    {
                        ...
                        //var singlecharge = JabehAbzarLibrary.MessageHandler.SendSinglechargeMesssageToPardisImi(message);
