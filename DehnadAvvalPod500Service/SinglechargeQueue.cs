        ...
        private void RemoveUsersFromSinglechargeWaitingList()
        {
            try
            {
                ...
                using (var entity = new AvvalPod500Entities())
                {
                    ...
                    DehnadAvvalPod500Service.SinglechargeInstallmentClass.TelepromoMapfaInstallmentJob(maxChargeLimit, 0, 0, serviceCode, chargeCodes, mobileNumbers, installmentListCount, installmentListTakeSize, serviceAdditionalInfo);
                }
            }
            catch (Exception e)
            {
        ...
        private void SendRenewalWarningToSinglechargeUsersInQueue()
        {
            try
            {
                ...
                using (var entity = new AvvalPod500Entities())
                {
                    ...
                    var serviceId = SharedLibrary.ServiceHandler.GetServiceId("AvvalPod500");
                    ...
                    foreach (var item in QueueList)
                    {
                        ...
                        var imiChargeObject = AvvalPod500Library.MessageHandler.GetImiChargeObjectFromPrice(0, SharedLibrary.HandleSubscription.ServiceStatusForSubscriberState.Unspecified);
                        ...
                        AvvalPod500Library.MessageHandler.InsertMessageToQueue(message);
            ...
            try
            {
                ...
                using (var entity = new AvvalPod500Entities())
                {
                    ...
                    foreach (var item in QueueList)
                    {
                        ...
                        //var singlecharge = AvvalPod500Library.MessageHandler.SendSinglechargeMesssageToPardisImi(message);
