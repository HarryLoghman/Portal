...
namespace DonyayeAsatirLibrary
{
    ...
    {
        public HandleMo() : base("DonyayeAsatir")
        {
        ...
        public static async Task<bool> ReceivedMessageOld2(MessageObject message, Service service)
        {
            ...
            try
            {
                using (var entity = new DonyayeAsatirEntities())
                {
                    ...
                    else if (message.Content == "00" || message.Content.Length == 7 || message.Content.Length == 8 || message.Content.Length == 9 || message.Content == "22" || message.Content.ToLower().Contains("abc"))
                    {
