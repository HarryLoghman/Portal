...
namespace DonyayeAsatirLibrary.Models
{
    ...
    public partial class DonyayeAsatirEntities : DbContext
    {
        public DonyayeAsatirEntities()
            : base("name=DonyayeAsatirEntities")
        {
        }
        ...
        public virtual int ResetSinglechargeDailyBalance()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("ResetSinglechargeDailyBalance");
        }
    }
}
