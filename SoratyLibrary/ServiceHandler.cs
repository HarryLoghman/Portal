...
namespace SoratyLibrary
{
    public class ServiceHandler
    {
        ...
        public static AutochargeContent SelectAutochargeContentByOrder(SoratyEntities entity, long subscriberId)
        {
        ...
        public static Singlecharge GetOTPRequestId(SoratyEntities entity, MessageObject message)
        {
            try
            {
        ...
        public static AutochargeContent SelectAutochargeContentByDate(SoratyEntities entity, long subscriberId)
        {
        ...
        public static AutochargeContent SelectAutochargeContent(SoratyEntities entity, long subscriberId)
        {
            var today = DateTime.Now.Date;
            var autochargesAlreadyInQueue = entity.AutochargeMessagesBuffers.Where(o => DbFunctions.TruncateTime(o.DateAddedToQueue) == today).Select(o => o.Id).ToList();
