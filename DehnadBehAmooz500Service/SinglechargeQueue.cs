        ...
        private void SendRenewalWarningToSinglechargeUsersInQueue()
        {
            try
            {
                ...
                using (var entity = new BehAmooz500Entities())
                {
                    ...
                    var serviceId = SharedLibrary.ServiceHandler.GetServiceId("BehAmooz500");
                    ...
                    foreach (var item in QueueList)
                    {
                        ...
                        var imiChargeObject = BehAmooz500Library.MessageHandler.GetImiChargeObjectFromPrice(0, SharedLibrary.HandleSubscription.ServiceStatusForSubscriberState.Unspecified);
                        ...
                        BehAmooz500Library.MessageHandler.InsertMessageToQueue(message);
            ...
            try
            {
                ...
                using (var entity = new BehAmooz500Entities())
                {
                    ...
                    foreach (var item in QueueList)
                    {
                        ...
                        //var singlecharge = BehAmooz500Library.MessageHandler.SendSinglechargeMesssageToPardisImi(message);
