...
namespace AsemanLibrary
{
    public class MessageHandler
    {
        ...
        public static MessageObject SetImiChargeInfo(AsemanEntities entity, ImiChargeCode imiChargeCode, MessageObject message, int price, int messageType, SharedLibrary.HandleSubscription.ServiceStatusForSubscriberState? subscriberState)
        {
        ...
        public static List<OnDemandMessagesBuffer> GetUnprocessedOnDemandMessages(AsemanEntities entity, int readSize)
        {
        ...
        public static List<EventbaseMessagesBuffer> GetUnprocessedEventbaseMessages(AsemanEntities entity, int readSize)
        {
            var today = DateTime.Now.Date;
        ...
        public static List<AutochargeMessagesBuffer> GetUnprocessedAutochargeMessages(AsemanEntities entity, int readSize)
        {
            var today = DateTime.Now.Date;
        ...
        public static async Task SendMesssagesToPardisImi(AsemanEntities entity, dynamic messages, Dictionary<string, string> serviceAdditionalInfo)
        {
            try
            {
        ...
        public static async Task SendMesssagesToHub(AsemanEntities entityDisposeIt, dynamic messages, Dictionary<string, string> serviceAdditionalInfo)
        {
            try
            {
        ...
        public static async Task SendMesssagesToTelepromo(AsemanEntities entity, dynamic messages, Dictionary<string, string> serviceAdditionalInfo)
        {
            try
            {
                var messagesCount = messages.Count;
        ...
        public static async Task SendMesssagesToHamrahvas(AsemanEntities entity, dynamic messages, Dictionary<string, string> serviceAdditionalInfo)
        {
