        ...
        private void SendRenewalWarningToSinglechargeUsersInQueue()
        {
            try
            {
                ...
                using (var entity = new MusicYadEntities())
                {
                    ...
                    var serviceId = SharedLibrary.ServiceHandler.GetServiceId("MusicYad");
                    ...
                    foreach (var item in QueueList)
                    {
                        ...
                        var imiChargeObject = MusicYadLibrary.MessageHandler.GetImiChargeObjectFromPrice(0, SharedLibrary.HandleSubscription.ServiceStatusForSubscriberState.Unspecified);
