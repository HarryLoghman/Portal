        ...
        private void SendRenewalWarningToSinglechargeUsersInQueue()
        {
            try
            {
                ...
                using (var entity = new HalgheEntities())
                {
                    ...
                    var serviceId = SharedLibrary.ServiceHandler.GetServiceId("Halghe");
                    ...
                    foreach (var item in QueueList)
                    {
                        ...
                        var imiChargeObject = HalgheLibrary.MessageHandler.GetImiChargeObjectFromPrice(0, SharedLibrary.HandleSubscription.ServiceStatusForSubscriberState.Unspecified);
                        ...
                        HalgheLibrary.MessageHandler.InsertMessageToQueue(message);
            ...
            try
            {
                ...
                using (var entity = new HalgheEntities())
                {
                    ...
                    foreach (var item in QueueList)
                    {
                        ...
                        //var singlecharge = HalgheLibrary.MessageHandler.SendSinglechargeMesssageToPardisImi(message);
