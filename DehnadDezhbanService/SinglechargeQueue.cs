        ...
        private void SendRenewalWarningToSinglechargeUsersInQueue()
        {
            try
            {
                ...
                using (var entity = new DezhbanEntities())
                {
                    ...
                    var serviceId = SharedLibrary.ServiceHandler.GetServiceId("Dezhban");
                    ...
                    foreach (var item in QueueList)
                    {
                        ...
                        var imiChargeObject = DezhbanLibrary.MessageHandler.GetImiChargeObjectFromPrice(0, SharedLibrary.HandleSubscription.ServiceStatusForSubscriberState.Unspecified);
            ...
            try
            {
                ...
                using (var entity = new DezhbanEntities())
                {
                    ...
                    foreach (var item in QueueList)
                    {
                        ...
                        //var singlecharge = DezhbanLibrary.MessageHandler.SendSinglechargeMesssageToPardisImi(message);
