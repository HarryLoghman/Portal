...
namespace Portal.Areas.PorShetab.Controllers
{
    ...
    public class SendDirectMessageController : Controller
    {
        ...
        // GET: PorShetab/SendDirectMessage
        ...
        public ActionResult Send([DataSourceRequest]DataSourceRequest request)
        {
            ...
            var service = SharedLibrary.ServiceHandler.GetServiceFromServiceCode("PorShetab");
            ...
            messageObject = PorShetabLibrary.MessageHandler.SetImiChargeInfo(messageObject, price, 0, null);
            PorShetabLibrary.MessageHandler.InsertMessageToQueue(messageObject);
            return Content("Ok");
        }
    }
}