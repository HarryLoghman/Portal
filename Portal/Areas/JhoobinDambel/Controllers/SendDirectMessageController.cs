...
namespace Portal.Areas.JhoobinDambel.Controllers
{
    [Authorize(Roles = "Admin")]
    public class SendDirectMessageController : Controller
    {
        static log4net.ILog logs = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
        // GET: JhoobinDambel/SendDirectMessage
        private JhoobinDambelEntities db = new JhoobinDambelEntities();

        public ActionResult Index()
        {
            ViewBag.ServiceName = "دمبل (ژوبین)";
            return View();
        }
        ...
        public ActionResult Send([DataSourceRequest]DataSourceRequest request)
        {
            ...
            var service = SharedLibrary.ServiceHandler.GetServiceFromServiceCode("JhoobinDambel");
            ...
            messageObject = JhoobinDambelLibrary.MessageHandler.SetImiChargeInfo(messageObject, price, 0, null);
            JhoobinDambelLibrary.MessageHandler.InsertMessageToQueue(messageObject);
            return Content("Ok");
        }
    }
}