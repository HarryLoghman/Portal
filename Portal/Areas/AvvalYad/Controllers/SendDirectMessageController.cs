...
namespace Portal.Areas.AvvalYad.Controllers
{
    ...
    public class SendDirectMessageController : Controller
    {
        ...
        public ActionResult Send([DataSourceRequest]DataSourceRequest request)
        {
            ...
            var service = SharedLibrary.ServiceHandler.GetServiceFromServiceCode("AvvalYad");
            ...
            messageObject = AvvalYadLibrary.MessageHandler.SetImiChargeInfo(messageObject, price, 0, null);
            AvvalYadLibrary.MessageHandler.InsertMessageToQueue(messageObject);
            return Content("Ok");
        }
    }
}