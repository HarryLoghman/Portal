...
namespace Portal.Areas.Medad.Controllers
{
    [Authorize(Roles = "Admin, MedadUser")]
    public class StatisticsController : Controller
    {
        static log4net.ILog logs = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
        // GET: Medad/Statistics
        private SharedLibrary.Models.ServiceModel.SharedServiceEntities db = new SharedLibrary.Models.ServiceModel.SharedServiceEntities("Medad");

        public ActionResult Index()
        {
            ViewBag.ServiceName = "مداد";
            return View();
        }
        ...
        public ActionResult Statistics_GridRead([DataSourceRequest]DataSourceRequest request)
        {
            ...
            else if (User.IsInRole("MedadUser"))
            {
                result = db.DailyStatistics.ToDataSourceResult(request, dailyStatistics => new
                {
                    Id = dailyStatistics.Id,
        ...
        public ActionResult Subscribers_Read([DataSourceRequest]DataSourceRequest request)
        {
            ...
            {
                var serviceId = portalEntity.Services.FirstOrDefault(o => o.ServiceCode == "Medad").Id;
