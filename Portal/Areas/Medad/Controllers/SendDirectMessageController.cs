...
namespace Portal.Areas.Medad.Controllers
{
    ...
    public class SendDirectMessageController : Controller
    {
        ...
        // GET: Medad/SendDirectMessage
        private MedadEntities db = new MedadEntities();
        ...
        public ActionResult Send([DataSourceRequest]DataSourceRequest request)
        {
            ...
            var service = SharedLibrary.ServiceHandler.GetServiceFromServiceCode("Medad");
            ...
            messageObject = MedadLibrary.MessageHandler.SetImiChargeInfo(messageObject, price, 0, null);
            MedadLibrary.MessageHandler.InsertMessageToQueue(messageObject);
            return Content("Ok");
        }
    }
}