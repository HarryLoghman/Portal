...
namespace Portal.Areas.Hazaran.Controllers
{
    ...
    public class SendDirectMessageController : Controller
    {
        ...
        public ActionResult Send([DataSourceRequest]DataSourceRequest request)
        {
            ...
            var service = SharedLibrary.ServiceHandler.GetServiceFromServiceCode("Hazaran");
            ...
            messageObject = HazaranLibrary.MessageHandler.SetImiChargeInfo(messageObject, price, 0, null);
            HazaranLibrary.MessageHandler.InsertMessageToQueue(messageObject);
            return Content("Ok");
        }
    }
}