...
namespace Portal.Areas.Soraty.Controllers
{
    ...
    public class SendDirectMessageController : Controller
    {
        ...
        // GET: Soraty/SendDirectMessage
        private SoratyEntities db = new SoratyEntities();
        ...
        public ActionResult Send([DataSourceRequest]DataSourceRequest request)
        {
            ...
            var service = SharedLibrary.ServiceHandler.GetServiceFromServiceCode("Soraty");
            ...
            messageObject = SoratyLibrary.MessageHandler.SetImiChargeInfo(messageObject, price, 0, null);
            SoratyLibrary.MessageHandler.InsertMessageToQueue(messageObject);
            return Content("Ok");
        }
    }
}