...
namespace Portal.Areas.Darchin.Controllers
{
    [Authorize(Roles = "Admin")]
    public class SendDirectMessageController : Controller
    {
        static log4net.ILog logs = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
        // GET: Darchin/SendDirectMessage
        private DarchinEntities db = new DarchinEntities();

        public ActionResult Index()
        {
            ViewBag.ServiceName = "دارچین";
            return View();
        }
        ...
        public ActionResult Send([DataSourceRequest]DataSourceRequest request)
        {
            ...
            messageObject = DarchinLibrary.MessageHandler.SetImiChargeInfo(messageObject, price, 0, null);
            DarchinLibrary.MessageHandler.InsertMessageToQueue(messageObject);
            return Content("Ok");
        }
    }
}