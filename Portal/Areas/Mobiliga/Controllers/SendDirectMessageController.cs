...
namespace Portal.Areas.Mobiliga.Controllers
{
    public class SendDirectMessageController : Controller
    {
        ...
        // GET: Mobiliga/SendDirectMessage
        ...
        public ActionResult Send([DataSourceRequest]DataSourceRequest request)
        {
            ...
            var service = SharedLibrary.ServiceHandler.GetServiceFromServiceCode("Mobiliga");
            ...
            messageObject = MobiligaLibrary.MessageHandler.SetImiChargeInfo(messageObject, price, 0, SharedLibrary.HandleSubscription.ServiceStatusForSubscriberState.Unspecified);
            MobiligaLibrary.MessageHandler.InsertMessageToQueue(messageObject);
            return Content("Ok");
        }
    }
}