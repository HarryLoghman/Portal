...
namespace Portal.Areas.Boating.Controllers
{
    public class SendDirectMessageController : Controller
    {
        ...
        public ActionResult Send([DataSourceRequest]DataSourceRequest request)
        {
            ...
            var service = SharedLibrary.ServiceHandler.GetServiceFromServiceCode("Boating");
            ...
            messageObject = BoatingLibrary.MessageHandler.SetImiChargeInfo(messageObject, price, 0, null);
            BoatingLibrary.MessageHandler.InsertMessageToQueue(messageObject);
            return Content("Ok");
        }
    }
}