...
namespace Portal.Areas.JhoobinMedad.Controllers
{
    [Authorize(Roles = "Admin")]
    public class SendDirectMessageController : Controller
    {
        static log4net.ILog logs = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
        // GET: JhoobinMedad/SendDirectMessage
        private JhoobinMedadEntities db = new JhoobinMedadEntities();

        public ActionResult Index()
        {
            ViewBag.ServiceName = "مداد (ژوبین)";
            return View();
        }
        ...
        public ActionResult Send([DataSourceRequest]DataSourceRequest request)
        {
            ...
            var service = SharedLibrary.ServiceHandler.GetServiceFromServiceCode("JhoobinMedad");
            ...
            messageObject = JhoobinMedadLibrary.MessageHandler.SetImiChargeInfo(messageObject, price, 0, null);
            JhoobinMedadLibrary.MessageHandler.InsertMessageToQueue(messageObject);
            return Content("Ok");
        }
    }
}