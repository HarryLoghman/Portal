...
namespace Portal.Areas.ShahreKalameh.Controllers
{
    public class SendDirectMessageController : Controller
    {
        ...
        // GET: ShahreKalameh/SendDirectMessage
        private ShahreKalamehEntities db = new ShahreKalamehEntities();

        public ActionResult Index()
        {
            ViewBag.ServiceName = "شهر کلمه";
            return View();
        }
        ...
        public ActionResult Send([DataSourceRequest]DataSourceRequest request)
        {
            ...
            var service = SharedLibrary.ServiceHandler.GetServiceFromServiceCode("ShahreKalameh");
            ...
            messageObject = ShahreKalamehLibrary.MessageHandler.SetImiChargeInfo(messageObject, price, 0, null);
            ShahreKalamehLibrary.MessageHandler.InsertMessageToQueue(messageObject);
            return Content("Ok");
        }
    }
}