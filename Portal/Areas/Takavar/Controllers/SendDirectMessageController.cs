...
namespace Portal.Areas.Takavar.Controllers
{
    ...
    public class SendDirectMessageController : Controller
    {
        ...
        // GET: Takavar/SendDirectMessage
        private TakavarEntities db = new TakavarEntities();
        ...
        public ActionResult Send([DataSourceRequest]DataSourceRequest request)
        {
            ...
            var service = SharedLibrary.ServiceHandler.GetServiceFromServiceCode("Takavar");
            ...
            messageObject = TakavarLibrary.MessageHandler.SetImiChargeInfo(messageObject, price, 0, null);
            TakavarLibrary.MessageHandler.InsertMessageToQueue(messageObject);
            return Content("Ok");
        }
    }
}