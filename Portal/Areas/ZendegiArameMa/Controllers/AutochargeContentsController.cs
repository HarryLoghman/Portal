...
namespace Portal.Areas.ZendegiArameMa.Controllers
{
    public class AutochargeContentsController : Controller
    {
        // GET: ZendegiArameMa/AutochargeContents
        private ZendegiArameMaEntities db = new ZendegiArameMaEntities();

        public ActionResult Index()
        {
            ViewBag.ServiceName = "زندگی آرام ما";
            return View();
        }
