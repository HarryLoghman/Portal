...
namespace Portal.Areas.AvvalPod.Controllers
{
    ...
    public class SendDirectMessageController : Controller
    {
        ...
        // GET: AvvalPod/SendDirectMessage
        ...
        public ActionResult Send([DataSourceRequest]DataSourceRequest request)
        {
            ...
            messageObject = AvvalPodLibrary.MessageHandler.SetImiChargeInfo(messageObject, price, 0, null);
            AvvalPodLibrary.MessageHandler.InsertMessageToQueue(messageObject);
            return Content("Ok");
        }
    }
}