...
namespace Portal.Areas.LahzeyeAkhar.Controllers
{
    [Authorize(Roles = "Admin")]
    public class SendDirectMessageController : Controller
    {
        static log4net.ILog logs = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
        // GET: LahzeyeAkhar/SendDirectMessage
        private LahzeyeAkharEntities db = new LahzeyeAkharEntities();

        public ActionResult Index()
        {
            ViewBag.ServiceName = "لحظه آخر";
            return View();
        }
        ...
        public ActionResult Send([DataSourceRequest]DataSourceRequest request)
        {
            ...
            var service = SharedLibrary.ServiceHandler.GetServiceFromServiceCode("LahzeyeAkhar");
            ...
            messageObject = LahzeyeAkharLibrary.MessageHandler.SetImiChargeInfo(messageObject, price, 0, null);
            LahzeyeAkharLibrary.MessageHandler.InsertMessageToQueue(messageObject);
            return Content("Ok");
        }
    }
}