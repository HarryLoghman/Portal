...
namespace Portal.Areas.JhoobinTahChin.Controllers
{
    [Authorize(Roles = "Admin")]
    public class SendDirectMessageController : Controller
    {
        static log4net.ILog logs = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
        // GET: JhoobinTahChin/SendDirectMessage
        private JhoobinTahChinEntities db = new JhoobinTahChinEntities();

        public ActionResult Index()
        {
            ViewBag.ServiceName = "ته چین (ژوبین)";
            return View();
        }
        ...
        public ActionResult Send([DataSourceRequest]DataSourceRequest request)
        {
            ...
            var service = SharedLibrary.ServiceHandler.GetServiceFromServiceCode("JhoobinTahChin");
            ...
            messageObject = JhoobinTahChinLibrary.MessageHandler.SetImiChargeInfo(messageObject, price, 0, null);
            JhoobinTahChinLibrary.MessageHandler.InsertMessageToQueue(messageObject);
            return Content("Ok");
        }
    }
}