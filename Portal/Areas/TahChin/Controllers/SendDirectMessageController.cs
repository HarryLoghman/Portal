...
namespace Portal.Areas.TahChin.Controllers
{
    ...
    public class SendDirectMessageController : Controller
    {
        ...
        public ActionResult Send([DataSourceRequest]DataSourceRequest request)
        {
            ...
            messageObject = TahChinLibrary.MessageHandler.SetImiChargeInfo(messageObject, price, 0, null);
            TahChinLibrary.MessageHandler.InsertMessageToQueue(messageObject);
            return Content("Ok");
        }
    }
}