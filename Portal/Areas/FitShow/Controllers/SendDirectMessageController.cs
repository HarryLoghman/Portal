...
namespace Portal.Areas.FitShow.Controllers
{
    ...
    public class SendDirectMessageController : Controller
    {
        ...
        public ActionResult Send([DataSourceRequest]DataSourceRequest request)
        {
            ...
            messageObject = FitShowLibrary.MessageHandler.SetImiChargeInfo(messageObject, price, 0, null);
            FitShowLibrary.MessageHandler.InsertMessageToQueue(messageObject);
            return Content("Ok");
        }
    }
}