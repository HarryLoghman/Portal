...
namespace Portal.Areas.Medio.Controllers
{
    ...
    public class SendDirectMessageController : Controller
    {
        ...
        public ActionResult Send([DataSourceRequest]DataSourceRequest request)
        {
            ...
            messageObject = MedioLibrary.MessageHandler.SetImiChargeInfo(messageObject, price, 0, null);
            MedioLibrary.MessageHandler.InsertMessageToQueue(messageObject);
            return Content("Ok");
        }
    }
}