...
namespace Portal.Areas.Tamly.Controllers
{
    public class SendDirectMessageController : Controller
    {
        ...
        // GET: Tamly/SendDirectMessage
        private TamlyEntities db = new TamlyEntities();
        ...
        public ActionResult Send([DataSourceRequest]DataSourceRequest request)
        {
            ...
            messageObject = TamlyLibrary.MessageHandler.SetImiChargeInfo(messageObject, price, 0, null);
            TamlyLibrary.MessageHandler.InsertMessageToQueue(messageObject);
            return Content("Ok");
        }
    }
}