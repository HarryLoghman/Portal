...
namespace Portal.Areas.TajoTakht.Controllers
{
    [Authorize(Roles = "Admin")]
    public class SendDirectMessageController : Controller
    {
        static log4net.ILog logs = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
        // GET: TajoTakht/SendDirectMessage
        private TajoTakhtEntities db = new TajoTakhtEntities();

        public ActionResult Index()
        {
            ViewBag.ServiceName = "تاج و تخت";
            return View();
        }
        ...
        public ActionResult Send([DataSourceRequest]DataSourceRequest request)
        {
            ...
            var service = SharedLibrary.ServiceHandler.GetServiceFromServiceCode("TajoTakht");
            ...
            messageObject = TajoTakhtLibrary.MessageHandler.SetImiChargeInfo(messageObject, price, 0, null);
            TajoTakhtLibrary.MessageHandler.InsertMessageToQueue(messageObject);
            return Content("Ok");
        }
    }
}