...
namespace Portal.Areas.JhoobinPorShetab.Controllers
{
    ...
    public class SendDirectMessageController : Controller
    {
        ...
        // GET: JhoobinPorShetab/SendDirectMessage
        ...
        public ActionResult Send([DataSourceRequest]DataSourceRequest request)
        {
            ...
            var service = SharedLibrary.ServiceHandler.GetServiceFromServiceCode("JhoobinPorShetab");
            ...
            messageObject = JhoobinPorShetabLibrary.MessageHandler.SetImiChargeInfo(messageObject, price, 0, null);
            JhoobinPorShetabLibrary.MessageHandler.InsertMessageToQueue(messageObject);
            return Content("Ok");
        }
    }
}