...
namespace Portal.Areas.BimeKarbala.Controllers
{
    public class SendDirectMessageController : Controller
    {
        static log4net.ILog logs = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
        // GET: BimeKarbala/SendDirectMessage
        private BimeKarbalaEntities db = new BimeKarbalaEntities();

        public ActionResult Index()
        {
            ViewBag.ServiceName = "بیمه کربلا";
            return View();
        }
        ...
        public ActionResult Send([DataSourceRequest]DataSourceRequest request)
        {
            ...
            var service = SharedLibrary.ServiceHandler.GetServiceFromServiceCode("BimeKarbala");
