...
namespace Portal.Areas.ShenoYad500.Controllers
{
    ...
    public class SendDirectMessageController : Controller
    {
        ...
        // GET: ShenoYad500/SendDirectMessage
        private ShenoYad500Entities db = new ShenoYad500Entities();
        ...
        public ActionResult Send([DataSourceRequest]DataSourceRequest request)
        {
            ...
            var service = SharedLibrary.ServiceHandler.GetServiceFromServiceCode("ShenoYad500");
            ...
            messageObject = ShenoYad500Library.MessageHandler.SetImiChargeInfo(messageObject, price, 0, null);
            ShenoYad500Library.MessageHandler.InsertMessageToQueue(messageObject);
            return Content("Ok");
        }
    }
}