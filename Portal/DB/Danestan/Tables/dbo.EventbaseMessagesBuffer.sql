CREATE TABLE [dbo].[EventbaseMessagesBuffer]
(
...
GO
ALTER TABLE [dbo].[EventbaseMessagesBuffer] ADD CONSTRAINT [PK_EventbaseMessagesBuffer] PRIMARY KEY CLUSTERED  ([Id]) ON [PRIMARY]
GO
CREATE UNIQUE NONCLUSTERED INDEX [IX_EventbaseMessagesBuffer] ON [dbo].[EventbaseMessagesBuffer] ([ContentId], [MobileNumber]) ON [PRIMARY]
GO
