...
namespace Tabriz2018Library
{
    public class MessageHandler
    {
        ...
        public static List<OnDemandMessagesBuffer> GetUnprocessedOnDemandMessages(Tabriz2018Entities entity, int readSize)
        {
        ...
        public static List<EventbaseMessagesBuffer> GetUnprocessedEventbaseMessages(Tabriz2018Entities entity, int readSize)
        {
            var today = DateTime.Now.Date;
        ...
        public static List<AutochargeMessagesBuffer> GetUnprocessedAutochargeMessages(Tabriz2018Entities entity, int readSize)
        {
            var today = DateTime.Now.Date;
        ...
        public static async Task SendMesssagesToPardisImi(Tabriz2018Entities entity, dynamic messages, Dictionary<string, string> serviceAdditionalInfo)
        {
            try
            {
                var messagesCount = messages.Count;
        ...
        public static async Task SendMesssagesToHamrahvas(Tabriz2018Entities entity, dynamic messages, Dictionary<string, string> serviceAdditionalInfo)
        {
