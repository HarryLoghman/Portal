...
namespace BoatingLibrary
{
    public class MessageHandler
    {
        ...
        public static List<OnDemandMessagesBuffer> GetUnprocessedOnDemandMessages(BoatingEntities entity, int readSize)
        {
        ...
        public static List<EventbaseMessagesBuffer> GetUnprocessedEventbaseMessages(BoatingEntities entity, int readSize)
        {
            var today = DateTime.Now.Date;
        ...
        public static List<AutochargeMessagesBuffer> GetUnprocessedAutochargeMessages(BoatingEntities entity, int readSize)
        {
            var today = DateTime.Now.Date;
        ...
        public static async Task SendMesssagesToPardisImi(BoatingEntities entity, dynamic messages, Dictionary<string, string> serviceAdditionalInfo)
        {
            try
            {
        ...
        public static async Task SendMesssagesToHamrahvas(BoatingEntities entity, dynamic messages, Dictionary<string, string> serviceAdditionalInfo)
        {
