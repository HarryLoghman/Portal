            ...
            try
            {
                ...
                using (var entity = new MenchBazEntities())
                {
                    ...
                    foreach (var item in QueueList)
                    {
                        ...
                        var imiChargeObject = MenchBazLibrary.MessageHandler.GetImiChargeObjectFromPrice(0, SharedLibrary.HandleSubscription.ServiceStatusForSubscriberState.Unspecified);
