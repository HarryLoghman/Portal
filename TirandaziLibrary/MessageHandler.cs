...
namespace TirandaziLibrary
{
    public class MessageHandler
    {
        ...
        public static List<OnDemandMessagesBuffer> GetUnprocessedOnDemandMessages(TirandaziEntities entity, int readSize)
        {
        ...
        public static List<EventbaseMessagesBuffer> GetUnprocessedEventbaseMessages(TirandaziEntities entity, int readSize)
        {
            var today = DateTime.Now.Date;
        ...
        public static List<AutochargeMessagesBuffer> GetUnprocessedAutochargeMessages(TirandaziEntities entity, int readSize)
        {
            var today = DateTime.Now.Date;
        ...
        public static async Task SendMesssagesToPardisImi(TirandaziEntities entity, dynamic messages, Dictionary<string, string> serviceAdditionalInfo)
        {
            try
            {
        ...
        public static async Task SendMesssagesToHamrahvas(TirandaziEntities entity, dynamic messages, Dictionary<string, string> serviceAdditionalInfo)
        {
