...
namespace DefendIranLibrary
{
    public class ServiceHandler
    {
        ...
        public static AutochargeContent SelectAutochargeContentByOrder(DefendIranEntities entity, long subscriberId)
        {
        ...
        public static Singlecharge GetOTPRequestId(DefendIranEntities entity, MessageObject message)
        {
            try
            {
        ...
        public static AutochargeContent SelectAutochargeContentByDate(DefendIranEntities entity, long subscriberId)
        {
        ...
        public static AutochargeContent SelectAutochargeContent(DefendIranEntities entity, long subscriberId)
        {
            var today = DateTime.Now.Date;
            var autochargesAlreadyInQueue = entity.AutochargeMessagesBuffers.Where(o => DbFunctions.TruncateTime(o.DateAddedToQueue) == today).Select(o => o.Id).ToList();
