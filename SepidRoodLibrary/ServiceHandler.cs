...
namespace SepidRoodLibrary
{
    public class ServiceHandler
    {
        ...
        public static AutochargeContent SelectAutochargeContentByOrder(SepidRoodEntities entity, long subscriberId)
        {
        ...
        public static AutochargeContent SelectAutochargeContentByDate(SepidRoodEntities entity, long subscriberId)
        {
