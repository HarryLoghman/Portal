...
using MobinOneMapfaTestLibrary;
        ...
        private void RemoveUsersFromSinglechargeWaitingList()
        {
            try
            {
                ...
                using (var entity = new MobinOneMapfaTestEntities())
                {
                    ...
                    SharedLibrary.InstallmentHandler.MapfaInstallmentJob(entityType, maxChargeLimit, 0, 0, serviceCode, chargeCodes, mobileNumbers, installmentListCount, installmentListTakeSize, serviceAdditionalInfo, singleChargeType);
                }
            }
            catch (Exception e)
            {
        ...
        private void SendRenewalWarningToSinglechargeUsersInQueue()
        {
            try
            {
                ...
                using (var entity = new MobinOneMapfaTestEntities())
                {
                    ...
                    var serviceId = SharedLibrary.ServiceHandler.GetServiceId("MobinOneMapfaTest");
                    ...
                    foreach (var item in QueueList)
                    {
                        ...
                        var imiChargeObject = MobinOneMapfaTestLibrary.MessageHandler.GetImiChargeObjectFromPrice(0, SharedLibrary.HandleSubscription.ServiceStatusForSubscriberState.Unspecified);
                        ...
                        MobinOneMapfaTestLibrary.MessageHandler.InsertMessageToQueue(message);
            ...
            try
            {
                ...
                using (var entity = new MobinOneMapfaTestEntities())
                {
                    ...
                    foreach (var item in QueueList)
                    {
                        ...
                        //var singlecharge = MobinOneMapfaTestLibrary.MessageHandler.SendSinglechargeMesssageToPardisImi(message);
