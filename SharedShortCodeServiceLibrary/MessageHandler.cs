...
namespace SharedShortCodeServiceLibrary
{
    public class MessageHandler
    {
        ...
        public static void AddEventbaseMessagesToQueue(string connectionStringNameInAppConfig, EventbaseContent eventbaseContent, long aggregatorId)
        {
        ...
        public static async Task SendMesssagesToPardisImi(ShortCodeServiceEntities entity, dynamic messages, Dictionary<string, string> serviceAdditionalInfo)
        {
            try
            {
        ...
        public static Singlecharge SendSinglechargeMesssageToPardisImi(string connectionStringNameInAppConfig, MessageObject message, long installmentId = 0)
        {
            if (message == null)
                return null;
        ...
        public static async Task SendMesssagesToHub(string connectionStringNameInAppConfig, ShortCodeServiceEntities entityDisposeIt, dynamic messages, Dictionary<string, string> serviceAdditionalInfo)
        {
            try
            {
        ...
        public static async Task SendMesssagesToTelepromo(ShortCodeServiceEntities entity, dynamic messages, Dictionary<string, string> serviceAdditionalInfo)
        {
            try
            {
                var messagesCount = messages.Count;
        ...
        public static async Task<Singlecharge> SendSinglechargeMesssageToTelepromo(string connectionStringNameInAppConfig, MessageObject message, Dictionary<string, string> serviceAdditionalInfo, long installmentId = 0)
        {
            var singlecharge = new Singlecharge();
            singlecharge.MobileNumber = message.MobileNumber;
            try
        ...
        public static async Task SendMesssagesToHamrahvas(ShortCodeServiceEntities entity, dynamic messages, Dictionary<string, string> serviceAdditionalInfo)
        {
