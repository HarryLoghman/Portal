...
namespace JhoobinMusicYadLibrary
{
    public class ServiceHandler
    {
        ...
        public static AutochargeContent SelectAutochargeContentByOrder(JhoobinMusicYadEntities entity, long subscriberId)
        {
        ...
        public static AutochargeContent SelectAutochargeContentByDate(JhoobinMusicYadEntities entity, long subscriberId)
        {
        ...
        public static AutochargeContent SelectAutochargeContent(JhoobinMusicYadEntities entity, long subscriberId)
        {
            var today = DateTime.Now.Date;
            var autochargesAlreadyInQueue = entity.AutochargeMessagesBuffers.Where(o => DbFunctions.TruncateTime(o.DateAddedToQueue) == today).Select(o => o.Id).ToList();
        ...
        public static Singlecharge GetOTPRequestId(JhoobinMusicYadEntities entity, MessageObject message)
        {
            try
            {
