...
namespace JhoobinMusicYadLibrary
{
    public class MessageHandler
    {
        ...
        public static long OtpLog(string mobileNumber, string otpType, string userMessage)
        {
            try
            {
                using (var entity = new JhoobinMusicYadEntities())
                {
                    var otpLog = new Otp()
                    {
        ...
        public static MessageObject SetImiChargeInfo(JhoobinMusicYadEntities entity, ImiChargeCode imiChargeCode, MessageObject message, int price, int messageType, SharedLibrary.HandleSubscription.ServiceStatusForSubscriberState? subscriberState)
        {
        ...
        public static List<OnDemandMessagesBuffer> GetUnprocessedOnDemandMessages(JhoobinMusicYadEntities entity, int readSize)
        {
        ...
        public static List<EventbaseMessagesBuffer> GetUnprocessedEventbaseMessages(JhoobinMusicYadEntities entity, int readSize)
        {
            var today = DateTime.Now.Date;
        ...
        public static List<AutochargeMessagesBuffer> GetUnprocessedAutochargeMessages(JhoobinMusicYadEntities entity, int readSize)
        {
            var today = DateTime.Now.Date;
        ...
        {
            var serviceCode = "JhoobinMusicYad";
        ...
        public static async Task SendMesssagesToPardisImi(JhoobinMusicYadEntities entity, dynamic messages, Dictionary<string, string> serviceAdditionalInfo)
        {
            try
            {
        ...
        public static async Task SendMesssagesToHub(JhoobinMusicYadEntities entityDisposeIt, dynamic messages, Dictionary<string, string> serviceAdditionalInfo)
        {
            try
            {
        ...
        public static async Task SendMesssagesToTelepromo(JhoobinMusicYadEntities entity, dynamic messages, Dictionary<string, string> serviceAdditionalInfo)
        {
            try
            {
                var messagesCount = messages.Count;
        ...
        public static async Task SendMesssagesToHamrahvas(JhoobinMusicYadEntities entity, dynamic messages, Dictionary<string, string> serviceAdditionalInfo)
        {
