...
namespace AvvalPodLibrary
{
    public class ServiceHandler
    {
        ...
        public static AutochargeContent SelectAutochargeContentByOrder(AvvalPodEntities entity, long subscriberId)
        {
        ...
        public static Singlecharge GetOTPRequestId(AvvalPodEntities entity, MessageObject message)
        {
            try
            {
        ...
        public static AutochargeContent SelectAutochargeContentByDate(AvvalPodEntities entity, long subscriberId)
        {
        ...
        public static AutochargeContent SelectAutochargeContent(AvvalPodEntities entity, long subscriberId)
        {
            var today = DateTime.Now.Date;
            var autochargesAlreadyInQueue = entity.AutochargeMessagesBuffers.Where(o => DbFunctions.TruncateTime(o.DateAddedToQueue) == today).Select(o => o.Id).ToList();
