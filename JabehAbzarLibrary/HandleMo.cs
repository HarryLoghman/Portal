...
namespace JabehAbzarLibrary
{
    public class HandleMo
    {
        ...
        public async static void ReceivedMessage(MessageObject message, Service service)
        {
            ...
            {
                Type entityType = typeof(JabehAbzarEntities);
                ...
                if (isUserSendsSubscriptionKeyword == true || isUserWantsToUnsubscribe == true)
                {
                    ...
                    {
                        bool isSubscriberdVerified = JabehAbzarLibrary.ServiceHandler.IsUserVerifedTheSubscription(message.MobileNumber, message.ServiceId, content);
