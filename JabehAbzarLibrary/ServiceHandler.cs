...
namespace JabehAbzarLibrary
{
    public class ServiceHandler
    {
        ...
        public static AutochargeContent SelectAutochargeContentByOrder(JabehAbzarEntities entity, long subscriberId)
        {
        ...
        public static Singlecharge GetOTPRequestId(JabehAbzarEntities entity, MessageObject message)
        {
            try
            {
        ...
        public static AutochargeContent SelectAutochargeContentByDate(JabehAbzarEntities entity, long subscriberId)
        {
        ...
        public static AutochargeContent SelectAutochargeContent(JabehAbzarEntities entity, long subscriberId)
        {
            var today = DateTime.Now.Date;
            var autochargesAlreadyInQueue = entity.AutochargeMessagesBuffers.Where(o => DbFunctions.TruncateTime(o.DateAddedToQueue) == today).Select(o => o.Id).ToList();
