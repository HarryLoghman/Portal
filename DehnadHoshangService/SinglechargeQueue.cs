        ...
        private void SendRenewalWarningToSinglechargeUsersInQueue()
        {
            try
            {
                ...
                using (var entity = new SharedLibrary.Models.ServiceModel.SharedServiceEntities(Properties.Settings.Default.ServiceCode))
                {
                    ...
                    var serviceId = SharedLibrary.ServiceHandler.GetServiceId("Hoshang");
            ...
            try
            {
                ...
                using (var entity = new SharedLibrary.Models.ServiceModel.SharedServiceEntities(Properties.Settings.Default.ServiceCode))
                {
                    ...
                    foreach (var item in QueueList)
                    {
                        ...
                        //var singlecharge = HoshangLibrary.MessageHandler.SendSinglechargeMesssageToPardisImi(message);
