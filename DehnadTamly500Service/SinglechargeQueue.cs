        ...
        private void SendRenewalWarningToSinglechargeUsersInQueue()
        {
            try
            {
                ...
                using (var entity = new Tamly500Entities())
                {
                    ...
                    var serviceId = SharedLibrary.ServiceHandler.GetServiceId("Tamly500");
                    ...
                    foreach (var item in QueueList)
                    {
                        ...
                        var imiChargeObject = Tamly500Library.MessageHandler.GetImiChargeObjectFromPrice(0, SharedLibrary.HandleSubscription.ServiceStatusForSubscriberState.Unspecified);
                        ...
                        Tamly500Library.MessageHandler.InsertMessageToQueue(message);
            ...
            try
            {
                ...
                using (var entity = new Tamly500Entities())
                {
                    ...
                    foreach (var item in QueueList)
                    {
                        ...
                        //var singlecharge = Tamly500Library.MessageHandler.SendSinglechargeMesssageToPardisImi(message);
