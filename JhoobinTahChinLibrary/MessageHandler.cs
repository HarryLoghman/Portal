...
namespace JhoobinTahChinLibrary
{
    public class MessageHandler
    {
        ...
        public static MessageObject SetImiChargeInfo(JhoobinTahChinEntities entity, ImiChargeCode imiChargeCode, MessageObject message, int price, int messageType, SharedLibrary.HandleSubscription.ServiceStatusForSubscriberState? subscriberState)
        {
        ...
        public static List<OnDemandMessagesBuffer> GetUnprocessedOnDemandMessages(JhoobinTahChinEntities entity, int readSize)
        {
        ...
        public static List<EventbaseMessagesBuffer> GetUnprocessedEventbaseMessages(JhoobinTahChinEntities entity, int readSize)
        {
            var today = DateTime.Now.Date;
        ...
        public static List<AutochargeMessagesBuffer> GetUnprocessedAutochargeMessages(JhoobinTahChinEntities entity, int readSize)
        {
            var today = DateTime.Now.Date;
        ...
        {
            var serviceCode = "JhoobinTahChin";
        ...
        public static async Task SendMesssagesToPardisImi(JhoobinTahChinEntities entity, dynamic messages, Dictionary<string, string> serviceAdditionalInfo)
        {
            try
            {
        ...
        public static async Task SendMesssagesToHub(JhoobinTahChinEntities entityDisposeIt, dynamic messages, Dictionary<string, string> serviceAdditionalInfo)
        {
            try
            {
        ...
        public static async Task SendMesssagesToTelepromo(JhoobinTahChinEntities entity, dynamic messages, Dictionary<string, string> serviceAdditionalInfo)
        {
            try
            {
                var messagesCount = messages.Count;
        ...
        public static async Task SendMesssagesToHamrahvas(JhoobinTahChinEntities entity, dynamic messages, Dictionary<string, string> serviceAdditionalInfo)
        {
