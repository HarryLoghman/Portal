...
namespace JhoobinTahChinLibrary
{
    public class ServiceHandler
    {
        ...
        public static AutochargeContent SelectAutochargeContentByOrder(JhoobinTahChinEntities entity, long subscriberId)
        {
        ...
        public static AutochargeContent SelectAutochargeContentByDate(JhoobinTahChinEntities entity, long subscriberId)
        {
        ...
        public static AutochargeContent SelectAutochargeContent(JhoobinTahChinEntities entity, long subscriberId)
        {
            var today = DateTime.Now.Date;
            var autochargesAlreadyInQueue = entity.AutochargeMessagesBuffers.Where(o => DbFunctions.TruncateTime(o.DateAddedToQueue) == today).Select(o => o.Id).ToList();
        ...
        public static Singlecharge GetOTPRequestId(JhoobinTahChinEntities entity, MessageObject message)
        {
            try
            {
