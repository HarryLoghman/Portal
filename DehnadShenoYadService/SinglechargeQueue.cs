        ...
        private void SendRenewalWarningToSinglechargeUsersInQueue()
        {
            try
            {
                ...
                using (var entity = new ShenoYadEntities())
                {
                    ...
                    var serviceId = SharedLibrary.ServiceHandler.GetServiceId("ShenoYad");
                    ...
                    foreach (var item in QueueList)
                    {
                        ...
                        var imiChargeObject = ShenoYadLibrary.MessageHandler.GetImiChargeObjectFromPrice(0, SharedLibrary.HandleSubscription.ServiceStatusForSubscriberState.Unspecified);
            ...
            try
            {
                ...
                using (var entity = new ShenoYadEntities())
                {
                    ...
                    foreach (var item in QueueList)
                    {
                        ...
                        //var singlecharge = ShenoYadLibrary.MessageHandler.SendSinglechargeMesssageToPardisImi(message);
