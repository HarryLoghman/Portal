...
namespace DehnadDambelService
{
    public partial class Service : ServiceBase
    {
        ...
        int v_cycleNumber = -1;
        public static string v_dbName = "dambel";
                    ...
                    else
                    {
                        ...
                        using (var portal = new SharedLibrary.Models.PortalEntities())
                        {
                            ...
                            if (serviceCycles.Count() == 0)
                                serviceCycles = portal.serviceCycles.Where(o => o.serviceID.ToString() == serviceId && o.startTime <= ts && ts <= o.endTime && (o.daysOfWeek.StartsWith(day + ",") || o.daysOfWeek.EndsWith("," + day) || o.daysOfWeek.Contains("," + day + ",") || o.daysOfWeek == day)).Select(o => o);
                            if (serviceCycles.Count() == 1)
                            {
                                ...
                                installmentCycleNumber = v_cycleNumber;
