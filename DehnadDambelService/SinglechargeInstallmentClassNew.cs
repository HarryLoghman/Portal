    ...
    public class SinglechargeInstallmentClassNew
    {
        ...
        public int ProcessInstallment(int installmentCycleNumber, int tpsOperator, int tps, DateTime lastExecutionTime, bool forciblyExecute)
        {
            ...
            try
            {
                ...
                using (var entity = new SharedLibrary.Models.ServiceModel.SharedServiceEntities(Properties.Settings.Default.ServiceCode))
                {
                    ...
                    ////{
                    ////    installmentListNotOrdered = portal.Subscribers.Where(o => o.ServiceId != 10039 && o.ServiceId != 10028 && o.ServiceId != 10025 && o.ServiceId != 10036 && o.DeactivationDate == null).GroupBy(o => o.MobileNumber).Select(o => new { MobileNumber = o.Key }).OrderBy(o => o.MobileNumber).Take(10000).Select(o => o.MobileNumber).ToList();
                    ////}
                    ...
                    ////new comment var randomList = installmentList.OrderBy(o => Guid.NewGuid()).ToList();
            ...
            , Dictionary<string, string> serviceAdditionalInfo, int tpsOperator, int tps)
        {
            ...
            try
            {
                ...
                //List<string> mobiles = installmentList.Keys.ToList();
                //List<int> chargedPrices = installmentList.Values.ToList();
                ...
                while (position < rowCount)
                {
                    ...
                    int currentTps = tps;
                    if (v_tpsDedicatedChanged) { v_tpsDedicatedChanged = false; currentTps = v_throttleDedicated.getMaxTps(tpsOperator, tps); logs.Info(";tpsChanged;Dambel;" + tps + ";" + tpsOperator + ";" + currentTps + ";"); }
                ...
                //    throttleDedicated.throttleRequests(Service.v_dbName, mobileNumber, Guid.NewGuid().ToString(), 1050, tps);
