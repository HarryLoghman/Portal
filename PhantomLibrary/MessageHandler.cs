...
namespace PhantomLibrary
{
    public class MessageHandler
    {
        ...
        public static List<OnDemandMessagesBuffer> GetUnprocessedOnDemandMessages(PhantomEntities entity, int readSize)
        {
            var today = DateTime.Now.Date;
        ...
        public static List<EventbaseMessagesBuffer> GetUnprocessedEventbaseMessages(PhantomEntities entity, int readSize)
        {
            var today = DateTime.Now.Date;
        ...
        public static List<AutochargeMessagesBuffer> GetUnprocessedAutochargeMessages(PhantomEntities entity, int readSize)
        {
            var today = DateTime.Now.Date;
        ...
        public static MessageObject SetImiChargeInfo(PhantomEntities entity, ImiChargeCode imiChargeCode, MessageObject message, int price, int messageType, SharedLibrary.HandleSubscription.ServiceStatusForSubscriberState? subscriberState)
        {
            if (subscriberState == null && price > 0)
        ...
        public static async Task SendMesssagesToPardisImi(PhantomEntities entity, dynamic messages, Dictionary<string, string> serviceAdditionalInfo)
        {
            try
            {
        ...
        public static async Task SendMesssagesToHub(PhantomEntities entityDisposeIt, dynamic messages, Dictionary<string, string> serviceAdditionalInfo)
        {
            try
            {
        ...
        public static async Task SendMesssagesToTelepromo(PhantomEntities entity, dynamic messages, Dictionary<string, string> serviceAdditionalInfo)
        {
            try
            {
                var messagesCount = messages.Count;
        ...
        public static async Task SendMesssagesToHamrahvas(PhantomEntities entity, dynamic messages, Dictionary<string, string> serviceAdditionalInfo)
        {
