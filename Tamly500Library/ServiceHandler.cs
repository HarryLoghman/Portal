...
namespace Tamly500Library
{
    public class ServiceHandler
    {
        ...
        public static AutochargeContent SelectAutochargeContentByOrder(Tamly500Entities entity, long subscriberId)
        {
        ...
        public static Singlecharge GetOTPRequestId(Tamly500Entities entity, MessageObject message)
        {
            try
            {
        ...
        public static AutochargeContent SelectAutochargeContentByDate(Tamly500Entities entity, long subscriberId)
        {
        ...
        public static AutochargeContent SelectAutochargeContent(Tamly500Entities entity, long subscriberId)
        {
            var today = DateTime.Now.Date;
            var autochargesAlreadyInQueue = entity.AutochargeMessagesBuffers.Where(o => DbFunctions.TruncateTime(o.DateAddedToQueue) == today).Select(o => o.Id).ToList();
