...
namespace TakavarLibrary
{
    public class MessageHandler
    {
        ...
        public static MessageObject SetImiChargeInfo(TakavarEntities entity, ImiChargeCode imiChargeCode, MessageObject message, int price, int messageType, SharedLibrary.HandleSubscription.ServiceStatusForSubscriberState? subscriberState)
        {
        ...
        public static async Task SendMesssagesToHub(TakavarEntities entityDisposeIt, dynamic messages, Dictionary<string, string> serviceAdditionalInfo)
        {
            try
            {
