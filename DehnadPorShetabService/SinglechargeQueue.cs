        ...
        private void RemoveUsersFromSinglechargeWaitingList()
        {
            try
            {
                ...
                using (var entity = new PorShetabLibrary.Models.PorShetabEntities())
                {
                    ...
                    SinglechargeInstallmentClass.InstallmentJob(maxChargeLimit, 0, 1, serviceCode, chargeCodes, mobileNumbers, installmentListCount, installmentListTakeSize, serviceAdditionalInfo);
                }
            }
            catch (Exception e)
            {
        ...
        private void SendRenewalWarningToSinglechargeUsersInQueue()
        {
            try
            {
                ...
                using (var entity = new PorShetabEntities())
                {
                    ...
                    var serviceId = SharedLibrary.ServiceHandler.GetServiceId("PorShetab");
