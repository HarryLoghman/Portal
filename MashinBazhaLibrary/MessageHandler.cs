...
namespace MashinBazhaLibrary
{
    public class MessageHandler
    {
        ...
        public static OnDemandMessagesBuffer CreateOnDemandMessageBuffer(MessageObject message)
        {
            ...
            messageBuffer.ContentId = (message.ContentId == null) ? 0 : message.ContentId;
        ...
        public static List<OnDemandMessagesBuffer> GetUnprocessedOnDemandMessages(MashinBazhaEntities entity, int readSize)
        {
        ...
        public static List<EventbaseMessagesBuffer> GetUnprocessedEventbaseMessages(MashinBazhaEntities entity, int readSize)
        {
            var today = DateTime.Now.Date;
        ...
        public static List<AutochargeMessagesBuffer> GetUnprocessedAutochargeMessages(MashinBazhaEntities entity, int readSize)
        {
            var today = DateTime.Now.Date;
        ...
        public static async Task SendMesssagesToPardisImi(MashinBazhaEntities entity, dynamic messages, Dictionary<string, string> serviceAdditionalInfo)
        {
            try
            {
        ...
        public static async Task SendMesssagesToHamrahvas(MashinBazhaEntities entity, dynamic messages, Dictionary<string, string> serviceAdditionalInfo)
        {
