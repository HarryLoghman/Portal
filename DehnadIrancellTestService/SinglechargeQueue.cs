        ...
        private void SendRenewalWarningToSinglechargeUsersInQueue()
        {
            try
            {
                ...
                using (var entity = new IrancellTestEntities())
                {
                    ...
                    var serviceId = SharedLibrary.ServiceHandler.GetServiceId("IrancellTest");
                    ...
                    foreach (var item in QueueList)
                    {
                        ...
                        var imiChargeObject = IrancellTestLibrary.MessageHandler.GetImiChargeObjectFromPrice(0, SharedLibrary.HandleSubscription.ServiceStatusForSubscriberState.Unspecified);
            ...
            try
            {
                ...
                using (var entity = new IrancellTestEntities())
                {
                    ...
                    foreach (var item in QueueList)
                    {
                        ...
                        //var singlecharge = IrancellTestLibrary.MessageHandler.SendSinglechargeMesssageToPardisImi(message);
