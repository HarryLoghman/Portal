...
namespace DehnadIrancellTestService
{
    class Sender : SharedShortCodeServiceLibrary.Sender
    {
        ...
        {
            base.SendHandler(IrancellTestLibrary.SharedVariables.prp_serviceEntity, new TimeSpan(8, 0, 0), new TimeSpan(20, 0, 0));
        }
        //public void SendHandler()
        //{
        //    try
        ...
        //        Type entityType = typeof(IrancellTestEntities);
