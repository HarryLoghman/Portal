...
namespace MobinOneMapfaTestLibrary
{
    public class MessageHandler
    {
        ...
        public static List<OnDemandMessagesBuffer> GetUnprocessedOnDemandMessages(MobinOneMapfaTestEntities entity, int readSize)
        {
        ...
        public static List<EventbaseMessagesBuffer> GetUnprocessedEventbaseMessages(MobinOneMapfaTestEntities entity, int readSize)
        {
            var today = DateTime.Now.Date;
        ...
        public static List<AutochargeMessagesBuffer> GetUnprocessedAutochargeMessages(MobinOneMapfaTestEntities entity, int readSize)
        {
            var today = DateTime.Now.Date;
        ...
        {
            var serviceCode = "MobinOneMapfaTest";
        ...
        public static async Task SendMesssagesToPardisImi(MobinOneMapfaTestEntities entity, dynamic messages, Dictionary<string, string> serviceAdditionalInfo)
        {
            try
            {
        ...
        public static async Task SendMesssagesToHub(MobinOneMapfaTestEntities entityDisposeIt, dynamic messages, Dictionary<string, string> serviceAdditionalInfo)
        {
            try
            {
        ...
        public static async Task SendMesssagesToTelepromo(MobinOneMapfaTestEntities entity, dynamic messages, Dictionary<string, string> serviceAdditionalInfo)
        {
            try
            {
                var messagesCount = messages.Count;
        ...
        public static async Task SendMesssagesToHamrahvas(MobinOneMapfaTestEntities entity, dynamic messages, Dictionary<string, string> serviceAdditionalInfo)
        {
