...
namespace DehnadMedadService
{
    public class SinglechargeInstallmentClassNew
    {
        ...
        public int ProcessInstallment(int installmentCycleNumber)
        {
            ...
            try
            {
                v_url = HelpfulFunctions.fnc_getServerActionURL(HelpfulFunctions.enumServers.MTN, HelpfulFunctions.enumServersActions.charge);
        ...
        private static Dictionary<string, int> getSubscribersDueToTotalPriceYesterday(SharedLibrary.Models.ServiceModel.SharedServiceEntities entity)
        {
