        ...
        private void RemoveUsersFromSinglechargeWaitingList()
        {
            try
            {
                ...
                using (var entity = new MedadEntities())
                {
                    ...
                    Type entityType = typeof(MedadEntities);
        ...
        private void SendRenewalWarningToSinglechargeUsersInQueue()
        {
            try
            {
                ...
                using (var entity = new MedadEntities())
                {
                    ...
                    var serviceId = SharedLibrary.ServiceHandler.GetServiceId("Medad");
                    ...
                    foreach (var item in QueueList)
                    {
                        ...
                        var imiChargeObject = MedadLibrary.MessageHandler.GetImiChargeObjectFromPrice(0, SharedLibrary.HandleSubscription.ServiceStatusForSubscriberState.Unspecified);
