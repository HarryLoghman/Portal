...
namespace JhoobinMedadLibrary
{
    public class ServiceHandler
    {
        ...
        public static AutochargeContent SelectAutochargeContentByOrder(JhoobinMedadEntities entity, long subscriberId)
        {
        ...
        public static AutochargeContent SelectAutochargeContentByDate(JhoobinMedadEntities entity, long subscriberId)
        {
        ...
        public static AutochargeContent SelectAutochargeContent(JhoobinMedadEntities entity, long subscriberId)
        {
            var today = DateTime.Now.Date;
            var autochargesAlreadyInQueue = entity.AutochargeMessagesBuffers.Where(o => DbFunctions.TruncateTime(o.DateAddedToQueue) == today).Select(o => o.Id).ToList();
        ...
        public static Singlecharge GetOTPRequestId(JhoobinMedadEntities entity, MessageObject message)
        {
            try
            {
