...
using JhoobinMedadLibrary.Models;
using System.Net.Http;
using System.Xml;
using System.Xml.Linq;

namespace JhoobinMedadLibrary
{
    public class MessageHandler
    {
        ...
        public static long OtpLog(string mobileNumber, string otpType, string userMessage)
        {
            try
            {
                using (var entity = new JhoobinMedadEntities())
                {
                    var otpLog = new Otp()
                    {
        ...
        public static MessageObject SetImiChargeInfo(JhoobinMedadEntities entity, ImiChargeCode imiChargeCode, MessageObject message, int price, int messageType, SharedLibrary.HandleSubscription.ServiceStatusForSubscriberState? subscriberState)
        {
        ...
        public static List<OnDemandMessagesBuffer> GetUnprocessedOnDemandMessages(JhoobinMedadEntities entity, int readSize)
        {
        ...
        public static List<EventbaseMessagesBuffer> GetUnprocessedEventbaseMessages(JhoobinMedadEntities entity, int readSize)
        {
            var today = DateTime.Now.Date;
        ...
        public static List<AutochargeMessagesBuffer> GetUnprocessedAutochargeMessages(JhoobinMedadEntities entity, int readSize)
        {
            var today = DateTime.Now.Date;
        ...
        public static async Task SendMesssagesToPardisImi(JhoobinMedadEntities entity, dynamic messages, Dictionary<string, string> serviceAdditionalInfo)
        {
            try
            {
        ...
        public static async Task SendMesssagesToHub(JhoobinMedadEntities entityDisposeIt, dynamic messages, Dictionary<string, string> serviceAdditionalInfo)
        {
            try
            {
        ...
        public static async Task SendMesssagesToTelepromo(JhoobinMedadEntities entity, dynamic messages, Dictionary<string, string> serviceAdditionalInfo)
        {
            try
            {
                var messagesCount = messages.Count;
        ...
        public static async Task SendMesssagesToHamrahvas(JhoobinMedadEntities entity, dynamic messages, Dictionary<string, string> serviceAdditionalInfo)
        {
