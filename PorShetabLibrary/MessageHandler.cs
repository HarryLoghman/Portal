...
namespace PorShetabLibrary
{
    public class MessageHandler
    {
        ...
        public static MessageObject SetImiChargeInfo(PorShetabEntities entity, ImiChargeCode imiChargeCode, MessageObject message, int price, int messageType, SharedLibrary.HandleSubscription.ServiceStatusForSubscriberState? subscriberState)
        {
        ...
        public static List<OnDemandMessagesBuffer> GetUnprocessedOnDemandMessages(PorShetabEntities entity, int readSize)
        {
        ...
        public static List<EventbaseMessagesBuffer> GetUnprocessedEventbaseMessages(PorShetabEntities entity, int readSize)
        {
            var today = DateTime.Now.Date;
        ...
        public static List<AutochargeMessagesBuffer> GetUnprocessedAutochargeMessages(PorShetabEntities entity, int readSize)
        {
            var today = DateTime.Now.Date;
        ...
        public static async Task SendMesssagesToPardisImi(PorShetabEntities entity, dynamic messages, Dictionary<string, string> serviceAdditionalInfo)
        {
            try
            {
        ...
        public static async Task SendMesssagesToHub(PorShetabEntities entityDisposeIt, dynamic messages, Dictionary<string, string> serviceAdditionalInfo)
        {
            try
            {
        ...
        public static async Task SendMesssagesToTelepromo(PorShetabEntities entity, dynamic messages, Dictionary<string, string> serviceAdditionalInfo)
        {
            try
            {
                var messagesCount = messages.Count;
        ...
        public static async Task SendMesssagesToHamrahvas(PorShetabEntities entity, dynamic messages, Dictionary<string, string> serviceAdditionalInfo)
        {
        ...
        public static string PrepareSubscriptionMessage(List<MessagesTemplate> messagesTemplate, SharedLibrary.HandleSubscription.ServiceStatusForSubscriberState serviceStatusForSubscriberState, int isCampaignActive)
        {
            ...
            switch (serviceStatusForSubscriberState)
            {
                case SharedLibrary.HandleSubscription.ServiceStatusForSubscriberState.Deactivated:
                    if (isCampaignActive == (int)CampaignStatus.MatchActiveReferralSuspend || isCampaignActive == (int)CampaignStatus.MatchActiveAndReferalDeactive)
