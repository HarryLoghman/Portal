...
namespace PorShetabLibrary
{
    public class ServiceHandler
    {
        ...
        public static AutochargeContent SelectAutochargeContentByOrder(PorShetabEntities entity, long subscriberId)
        {
        ...
        public static Singlecharge GetOTPRequestId(PorShetabEntities entity, MessageObject message)
        {
            try
            {
        ...
        public static AutochargeContent SelectAutochargeContentByDate(PorShetabEntities entity, long subscriberId)
        {
        ...
        public static AutochargeContent SelectAutochargeContent(PorShetabEntities entity, long subscriberId)
        {
            var today = DateTime.Now.Date;
            var autochargesAlreadyInQueue = entity.AutochargeMessagesBuffers.Where(o => DbFunctions.TruncateTime(o.DateAddedToQueue) == today).Select(o => o.Id).ToList();
