                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    else if (message.ServiceCode == "ShenoYad")
                                    {
                                        var singlecharge = ShenoYadLibrary.HandleMo.ReceivedMessageForSingleCharge(message, service);
                                        if (singlecharge == null)
                                            result.Status = "Error in Charging";
                                        else
                                        {
                                    ...
                                    else if (message.ServiceCode == "Takavar")
                                    {
                                        var singlecharge = TakavarLibrary.HandleMo.ReceivedMessageForSingleCharge(message, service);
                                        if (singlecharge == null)
                                            result.Status = "Error in Charging";
                                        else
                                        {
                                    ...
                                    else if (message.ServiceCode == "AvvalYad")
                                    {
                                        var singlecharge = AvvalYadLibrary.HandleMo.ReceivedMessageForSingleCharge(message, service);
                                        if (singlecharge == null)
                                            result.Status = "Error in Charging";
                                        else
                                        {
