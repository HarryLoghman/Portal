...
namespace ShenoYad500Library
{
    public class ServiceHandler
    {
        ...
        public static AutochargeContent SelectAutochargeContentByOrder(ShenoYad500Entities entity, long subscriberId)
        {
        ...
        public static Singlecharge GetOTPRequestId(ShenoYad500Entities entity, MessageObject message)
        {
            try
            {
        ...
        public static AutochargeContent SelectAutochargeContentByDate(ShenoYad500Entities entity, long subscriberId)
        {
        ...
        public static AutochargeContent SelectAutochargeContent(ShenoYad500Entities entity, long subscriberId)
        {
            var today = DateTime.Now.Date;
            var autochargesAlreadyInQueue = entity.AutochargeMessagesBuffers.Where(o => DbFunctions.TruncateTime(o.DateAddedToQueue) == today).Select(o => o.Id).ToList();
