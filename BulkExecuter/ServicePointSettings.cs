    ...
    public class ServicePointSettings : ConfigurationSection
    {
        ...
        public ServicePoint GetServicePoint()
        {
            ...
            catch (Exception ex)
            {
                ...
                SharedLibrary.HelpfulFunctions.sb_sendNotification_SingleChargeGang(System.Diagnostics.Eventing.Reader.StandardEventLevel.Error, "Error in fnc_getServicePoint:" + ex.Message);
            }
            return null;
        }
