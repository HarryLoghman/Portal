        ...
        private void SendRenewalWarningToSinglechargeUsersInQueue()
        {
            try
            {
                ...
                using (var entity = new LahzeyeAkharEntities())
                {
                    ...
                    var serviceId = SharedLibrary.ServiceHandler.GetServiceId("LahzeyeAkhar");
            ...
            try
            {
                ...
                using (var entity = new LahzeyeAkharEntities())
                {
                    ...
                    foreach (var item in QueueList)
                    {
                        ...
                        //var singlecharge = LahzeyeAkharLibrary.MessageHandler.SendSinglechargeMesssageToPardisImi(message);
