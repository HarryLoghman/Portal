...
namespace DambelLibrary
{
    public class ContentManager
    {
        ...
        public static void HandleContent(MessageObject message, vw_servicesServicesInfo service, Subscriber subscriber, List<SharedLibrary.Models.ServiceModel.MessagesTemplate> messagesTemplate)
        {
            try
            {
                using (var entity = new DambelEntities())
